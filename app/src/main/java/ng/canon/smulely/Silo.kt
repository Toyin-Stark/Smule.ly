...
import kotlinx.android.synthetic.main.silo.*
import java.io.File
import java.util.*

class Silo : AppCompatActivity(),SwipeRefreshLayout.OnRefreshListener {
    ...
    fun FileQuery() {
        ...
        arrayList!!.clear()
        path = Environment.getExternalStorageDirectory().absolutePath + "/smuley/"
        ...
        observable!!.subscribeOn(Schedulers.io())
                ...
                .subscribe(object: Observer<String> {
                    override fun onComplete() {
                        ...
                        adapter = Photo_Adapter(applicationContext, arrayList!!, this@Silo)
...
class Photo_Adapter(var context: Context, var arraylists: ArrayList<Photo_Model>, var downloads: Silo) :
    ...
    class Item(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bindData(_data: Photo_Model, _cube: Silo) {
